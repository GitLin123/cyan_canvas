...
const AllInOneDemo = () => {
  ...
  const TAB_HEIGHT = 52
  const SCROLL_HEIGHT = H - HEADER_HEIGHT - TAB_HEIGHT
  ...
  return (
    <Column width={W} height={H}>
      {/* 标题 */}
      <Container width={W} height={HEADER_HEIGHT} color="#1a1a2e" padding={12}>
        <Center>
      ...
      {/* Tab 栏 */}
      <Container width={W} height={TAB_HEIGHT} color="#1a1a2e" padding={8}>
      ...
      {/* 内容区域 - 可滚动 */}
      <SingleChildScrollView width={W} height={SCROLL_HEIGHT} direction="vertical">
        {renderTab()}
